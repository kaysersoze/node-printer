var printer_helper = {},
    ...
    os = require("os"),
    path = require("path"),
    binding_path = path.resolve(__dirname, './binding/node_printer.node'),
    precompiled_path = path.resolve(__dirname, './precompiled/node_printer_'+process.platform+'_'+process.arch+'.node'),
    printer_helper;
